...
Once you have the compiled YAML file, download it. In vSphere Enterprise Kubeflow web UI, go to pipelines dashaborad by clicking the **Pipelines** on the left-side navigation. And then click the **+ Upload pipeline** button.
